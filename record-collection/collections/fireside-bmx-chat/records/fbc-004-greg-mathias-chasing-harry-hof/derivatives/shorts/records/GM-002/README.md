...
| Parent transcript reference | 1:54-2:10 (provisional) |

## Visible published title

> 2. Greg Mathias donated a Harry Leary bobblehead to the @usabmxvideos HOF - A HLT miniature too
...
> Fireside BMX Chat w/ Greg Mathias - A Harry Leary Bobblehead figure was donated to the HoF

## Supplied description

A Harry Leary Bobblehead figure was also donated to the National BMX Hall of Fame (HoF) with a miniature Harry Leary Turbo (HLT) replica miniature frame.

**Description source:** working-source PDF.

## Evidence

- [Published-frame capture](../../source/evidence/published-frames-original/2026-07-22_15-52-45.png)
