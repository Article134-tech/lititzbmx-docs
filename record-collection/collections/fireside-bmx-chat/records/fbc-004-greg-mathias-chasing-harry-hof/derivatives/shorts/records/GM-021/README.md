...
| Parent transcript reference | 19:28-20:17 (provisional) |

## Visible published title

> 21. Greg Mathias started Fall Risk Racing (FRR) - he started it around 2015 and sold it to grow it
...
> Fireside BMX Chat w/ Greg Mathias - Greg Mathias started Fall Risk Racing (FRR)

## Supplied description

Greg Mathias started Fall Risk Racing, not in 1980 something, but in 2015 or so. He has since sold the company to someone in Pennsylvania - go to a track and you may see them represented.

**Description source:** working-source PDF.

## Evidence

- [Published-frame capture](../../source/evidence/published-frames-original/2026-07-22_16-39-35.png)
